...
public class WebSocketConnection implements WebSocket {
    ...
    public void connect(String wsUri, String[] wsSubprotocols, ConnectionHandler wsHandler, WebSocketOptions options, List<BasicNameValuePair> headers) throws WebSocketException {
